...
<head>
    ...
    <link href="'{{asset('Biz/css/font-awesome.min.css')}}" rel="stylesheet">
    <link href="'{{asset('Biz/css/animate.min.css')}}" rel="stylesheet">
    <link href="'{{asset('Biz/css/owl.carousel.css')}}" rel="stylesheet">
    <link href="'{{asset('Biz/css/owl.transitions.css')}}" rel="stylesheet">
    <link href="'{{asset('Biz/css/main.css')}}" rel="stylesheet">
    <!--[if lt IE 9]>
    <script src="{{asset('Biz/js/html5shiv.js"></script>
    <script src="{{asset('Biz/js/respond.min.js"></script>
    <![endif]-->       
        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top top-nav-collapse" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="{{asset('Biz/images/logo.png')}}" alt="logo"></a>
                </div>
                ...
                <div class="features">
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms">
                        <div class="media service-box">
                            <div class="pull-left">
                                <img src="{{asset('Biz/images/icon1.png')}}" alt="img">
                            </div>
...
ing elit, sed do eiusmod .</p>
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="100ms">
                        <div class="media service-box">
                            <div class="pull-left">
                                <img src="{{asset('Biz/images/icon2.png')}}" alt="img">
                            </div>
                            <div class="media-body">
...
ing elit, sed do eiusmod .</p>
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="200ms">
                        <div class="media service-box">
                            <div class="pull-left">
                                <img src="{{asset('Biz/images/icon3.png')}}" alt="img">
                            </div>
                            <div class="media-body">
...
ing elit, sed do eiusmod .</p>
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
                        <div class="media service-box">
                            <div class="pull-left">
                               <img src="{{asset('Biz/images/icon4.png')}}" alt="img">
                            </div>
                            <div class="media-body">
...
ing elit, sed do eiusmod .</p>
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms">
                        <div class="media service-box">
                            <div class="pull-left">
                               <img src="{{asset('Biz/images/icon5.png')}}" alt="img">
                            </div>
                            <div class="media-body">
...
ing elit, sed do eiusmod .</p>
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="500ms">
                        <div class="media service-box">
                            <div class="pull-left">
                                <img src="{{asset('Biz/images/icon6.png')}}" alt="img">
                            </div>
                            <div class="media-body">
...
ing elit, sed do eiusmod .</p>
            ...
            <div class="portfolio-items">
                <div class="portfolio-item creative">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{asset('Biz/images/work_1.jpg')}}" alt="">
                ...
                <div class="portfolio-item corporate portfolio">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{asset('Biz/images/work_2.jpg')}}" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item creative">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{asset('Biz/images/work_3.jpg')}}" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item corporate">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{asset('Biz/images/work_4.jpg')}}" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item creative portfolio">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{asset('Biz/images/work_5.jpg')}}" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item corporate">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{asset('Biz/images/work_6.jpg')}}" alt="">
                        <div class="portfolio-info">
                            <h3>Portfolio Item 5</h3>
                            Lorem Ipsum Dolor Sit
                ...
                <div class="portfolio-item creative portfolio">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{asset('Biz/images/work_7.jpg')}}" alt="">
                        <div class="portfolio-info">
                ...
                <div class="portfolio-item corporate">
                    <div class="portfolio-item-inner">
                        <img class="img-responsive" src="{{asset('Biz/images/work_8.jpg')}}" alt="">
                        <div class="portfolio-info">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="0ms">
                        <div class="team-img">
                            <img src="{{asset('Biz/images/team_1.jpg')}}" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Bin Burhan</h3>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="100ms">
                        <div class="team-img">
                            <img src="{{asset('Biz/images/team_2.jpg')}}" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Jane Man</h3>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="200ms">
                        <div class="team-img">
                            <img src="{{asset('Biz/images/team_3.jpg')}}" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Pahlwan</h3>
                            <span>Designer</span>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="300ms">
                        <div class="team-img">
                            <img src="{{asset('Biz/images/team_4.jpg')}}" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Nasir uddin</h3>
                            <span>UI/UX</span>
                        ...
                        <article>
                            <header class="entry-header">
                                <div class="entry-thumbnail">
                                    <img src="{{asset('Biz/images/blog1.jpg')}}" alt="">
                ...
                <div class="text-center item">
                    <div class="blog-post blog-large wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="0ms">
                        <article>
                            <header class="entry-header">
                                <div class="entry-thumbnail">
                                    <img src="{{asset('Biz/images/blog2.jpg')}}" alt="">
                ...
                <div class="text-center item">
                    <div class="blog-post blog-large wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="0ms">
                        <article>
                            <header class="entry-header">
                                <div class="entry-thumbnail">
                                    <img  src="{{asset('Biz/images/blog3.jpg')}}" alt="">
    ...
    <section id="testimonial">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                <div class="panel-one">
                <div class="user-img"><img alt="" src="{{asset('Biz/images/testimonail_1.jpg')}}"></div>
                ...
                <div class="col-sm-6">
                <div class="panel-one">
                <div class="user-img"><img alt="" src="{{asset('Biz/images/testimonail_2.jpg')}}"></div>
                <div class="testi-info">
                <h4>Jonathon Andrew</h4>
                <h5>Lorem ipsum dolor sit amet</h5>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed doeiusmod tempor incididunt ut labore et dolore magna aliqua Lorem ipsum dolor sit amet, consectetur.</p>
                ...
                <div class="col-sm-6">
                <div class="panel-one">
                <div class="user-img"><img alt="" src="{{asset('Biz/images/testimonail_3.jpg')}}"></div>
                <div class="testi-info">
                <h4>Jonathon Andrew</h4>
                <h5>Lorem ipsum dolor sit amet</h5>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed doeiusmod tempor incididunt ut labore et dolore magna aliqua Lorem ipsum dolor sit amet, consectetur.</p>
                ...
                <div class="col-sm-6">
                <div class="panel-one">
                <div class="user-img"><img alt="" src="{{asset('Biz/images/testimonail_4.jpg')}}"></div>
                <div class="testi-info">
                <h4>Jonathon Andrew</h4>
                <h5>Lorem ipsum dolor sit amet</h5>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed doeiusmod tempor incididunt ut labore et dolore magna aliqua Lorem ipsum dolor sit amet, consectetur.</p>
 ...
 sed do ETX eiusmod tempor incididunt ut labore et</p>
    ...
    <script src="{{asset('Biz/js/jquery.js')}}"></script>
    <script src="{{asset('Biz/js/bootstrap.min.js"></script>
    <script src="{{asset('Biz/http://maps.google.com/maps/api/js?sensor=true')}}"></script>
    <script src="{{asset('Biz/js/owl.carousel.min.js')}}"></script>
    <script src="{{asset('Biz/js/mousescroll.js')}}"></script>
    <script src="{{asset('Biz/js/smoothscroll.js')}}"></script>
    <script src="{{asset('Biz/js/jquery.prettyPhoto.js')}}"></script>
    <script src="{{asset('Biz/js/jquery.isotope.min.js')}}"></script>
    <script src="{{asset('Biz/js/jquery.inview.min.js')}}"></script>
    <script src="{{asset('Biz/js/wow.min.js')}}"></script>
    <script src="{{asset('Biz/js/main.js')}}"></script>
	<script src="{{asset('Biz/js/scrolling-nav.js')}}"></script>
<script>
