...
<html lang="en">
	<head>
		...
		<!--[if lt IE 9]>
		  <script src="{{asset('assets/frontend/https://oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js')}}"></script>
		  <script src="A{{asset('assets/frontend/https://oss.maxcdn.com/respond/1.4.2/respond.min.js')}}"></script>
		<![endif]-->
					...
					<main id="main" class="col-md-9">
						...
						<div class="article causes-details">
							...
							<div class="article-img">
								<img src="{{asset('assets/frontend/img/post-img.jpg')}}" alt="">
							</div>
							<!-- article img -->
